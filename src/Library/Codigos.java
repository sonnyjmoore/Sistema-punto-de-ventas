 ...
 * @author AJPDHN
 */
public class Codigos extends Objectos {
    ...
    public String codigoBarra(
        ...
        if (0 < Productos().size()) {
            product1 = Productos().stream()
                    .filter(p -> p.getProducto().replace(" ", "").toLowerCase()
                    .equals(producto.replace(" ", "").toLowerCase())
                    && p.getPrecio().equals(precio1))
        ...
        if (codigosBarra.equals("")) {
            ...
            var product2 = Productos().stream()
                    .filter(p -> p.getCodigo().equals(codigosBarra))
                    .collect(Collectors.toList());
            if (0 < product2.size()) {
                if (0 < product1.size()) {
